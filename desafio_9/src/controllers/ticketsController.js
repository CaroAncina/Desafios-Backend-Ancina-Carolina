...
export const getAllTickets = async (req, res) => {
    try {
        ...
        res.status(500).json({ result: 'error', error: 'Error al obtener los tickets' });
    }
};
...
export const getTicketById = async (req, res) => {
    try {
        ...
        res.status(500).json({ result: 'error', error: 'Error al obtener el ticket' });
    }
};
...
export const createTicket = async (req, res) => {
    try {
        ...
        res.status(500).json({ result: 'error', error: 'Error al crear el ticket' });
    }
};
...
export const updateTicket = async (req, res) => {
    try {
        ...
        res.status(500).json({ result: 'error', error: 'Error al actualizar el ticket' });
    }
};
...
export const deleteTicket = async (req, res) => {
    try {
        ...
        res.status(500).json({ result: 'error', error: 'Error al eliminar el ticket' });
    }
};
